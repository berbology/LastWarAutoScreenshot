...
| `Show-ConfigMenuScreen.ps1` | Configuration area selection menu (Logging / Mouse control / Emergency stop / Storage) |
...
| `Show-StorageInfoScreen.ps1` | Display storage usage chart; configure `Screenshots.*` keys |
